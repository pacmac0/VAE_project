...
parser.add_argument("--z1_size", type=int, default=40, metavar="M1", help="latent size")
parser.add_argument("--z2_size", type=int, default=40, metavar="M2", help="latent size")
parser.add_argument(
