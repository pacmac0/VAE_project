...
# =======================================================================================================================
def xavier_init(m):
    s = np.sqrt(2.0 / (m.in_features + m.out_features))
...
# =======================================================================================================================
def normal_init(m, mean=0.0, std=0.01):
...
class ResUnitBN(nn.Module):
    ...
    def __init__(
        ...
        self.conv1 = nn.Conv2d(
            number_channels, number_channels, kernel_size, stride, padding, dilation
        )
...
class GatedResUnit(nn.Module):
    def __init__(self, input_channels, activation=None):
        ...
        self.conv1 = GatedConv2d(
            input_channels, input_channels, 3, 1, 1, 1, activation=activation
        )
